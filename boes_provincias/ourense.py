# https://bop.depourense.es/portal/consulta?fecha=20240320
...
def boe_ourense(dia_boe, mes_boe, anno_boe, palabras):
    url = (f'https://bop.depourense.es/portal/consulta?fecha={anno_boe}{mes_boe}{dia_boe}')
