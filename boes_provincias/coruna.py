# https://bop.dicoruna.es/bopportal/cambioBoletin.do?fechaInput=19/03/2024
...
def boe_coruna(dia_boe, mes_boe, anno_boe, palabras):
    url = (f'https://bop.dicoruna.es/bopportal/cambioBoletin.do?fechaInput={dia_boe}/{mes_boe}/{anno_boe}')
